...
class Editor {
	...
	public function editor() {
		...
		$columns            = BWCEdit_Data()->get_culumns_type_title();
		...
		$full_screen_title = get_option( 'vi_wbe_full_screen_option' ) ? esc_html__( 'Exit full screen', 'bulky-bulk-edit-products-for-woo' ) : esc_html__( 'Full screen', 'bulky-bulk-edit-products-for-woo' );
                    ...
                    <div class="vi-wbe-sidebar-wrapper">
                        ...
                        <div class="vi-wbe-sidebar-inner">
                            ...
                            <div class="vi-ui bottom attached active tab segment" data-tab="filter">
                                <form class="" id="vi-wbe-products-filter">
									...
									$this->filter_input_element( [
										'type'        => 'multi-select',
										'id'          => 'product_cat',
										'options'     => [ '' => esc_html__( 'Categories', 'bulky-bulk-edit-products-for-woo' ) ] + BWCEdit_Data()->get_categories(),
									...
									$this->filter_input_element( [
										'type'        => 'multi-select',
										'id'          => 'product_tag',
										'options'     => [ '' => esc_html__( 'Tags', 'bulky-bulk-edit-products-for-woo' ) ] + BWCEdit_Data()->get_product_tags(),
										'name_prefix' => 'taxonomies',
										'operator'    => true,
									] );
                            ...
                            <div class="vi-ui bottom attached tab segment" data-tab="settings">
								...
								<?php do_action( 'villatheme_support_' . BULKY_CONST_F['slug'] ); ?>
	...
	public function setting_input_element( $args ) {
		...
		$data  = BWCEdit_Data()->get_settings();
		$value = $data[ $args['id'] ] ?? '';
		$this->core_elements( $args, $value );
	}
